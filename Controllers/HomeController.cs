...
public class HomeController : Controller
{
    ...
    public IActionResult Index()
    {
        ...
        Cliente cliente2 = new Cliente(02, "William Henry", "039.618.250-09", "bill@mecrosoft.com", "Bug");
        ...
        List<Cliente> listaClinetes = new List<Cliente>();
        listaClinetes.Add(cliente1);
        listaClinetes.Add(cliente2);
        listaClinetes.Add(cliente3);
        listaClinetes.Add(cliente4);
        listaClinetes.Add(cliente5);

        ViewBag.listaClinetes = listaClinetes;
